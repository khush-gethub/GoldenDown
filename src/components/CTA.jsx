...
const CTA = () => {
    return (
        <>
            <div className="bg-[#312E29] text-[#F8F6F0] flex flex-col items-center xl:mt-23.75 xl:pb-23.75 mt-10 pb-31">
                ...
                <div className="xl:flex xl:gap-6 xl:mt-12.5 mt-8">
                    <div className="xl:h-182.5 xl:w-112.5 w-90 h-140 flex flex-col gap-2 text-[14px] xl:text-[16px]">
                ...
                <div className="relative xl:mt-20">
                    <img src={img4} alt="" className='xl:w-360 xl:h-150 md:w-150 md:h-70 w-90 h-100 object-cover object-top rounded' />
